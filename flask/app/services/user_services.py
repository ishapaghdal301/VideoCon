...
class UserService:
    @staticmethod
    def create_user(first_name, last_name, email, username, password):  # Add username parameter
    ...
    def get_user_by_email(email):
        ...
        if user_data:
            user = User(user_data['first_name'], user_data['last_name'], user_data['email'], user_data['username'], user_data['password'])
            return user
        return None
