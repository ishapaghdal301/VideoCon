        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                mp_drawing.draw_landmarks(
                    ...
                    landmark_drawing_spec=mp_drawing.DrawingSpec(color=(0, 0, 0, 0.01), thickness=1, circle_radius=1),  # White lines with transparency (alpha = 128)
                )
                ...
                cv2.line(image, p1, p2, (0, 0, 0, 0.01), 2)  # Blue line with transparency (alpha = 128)
                cv2.putText(image, text, (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255, 128), 2)  # Red text with transparency (alpha = 128)
